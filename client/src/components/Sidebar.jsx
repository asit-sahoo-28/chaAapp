        ...
        {filteredUsers.map((user, index) => (
          ...
          >
            ...
            {(unseenMessages?.[user._id] ?? 0) > 0 && (
              <p className='absolute top-2 right-4 text-xs h-5 w-5 flex justify-center items-center rounded-full bg-violet-500/50'>
...
//   const filteredUser = search ? users.filter(u => u.fullName.toLowerCase().includes(search.toLowerCase())) : users;
